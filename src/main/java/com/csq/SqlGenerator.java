...
public class SqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String className = "com.csq.entity.SchoolBus";
        // 获取包下的所有类名称
...
//			String varchar = " varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,";
            ...
            sql.append("\n DROP TABLE IF EXISTS `" + tableName.substring(1,tableName.length()) + "`; ")
                    .append(" \n CREATE TABLE `" + tableName.substring(1,tableName.length()) + "`  (")
